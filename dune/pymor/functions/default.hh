...
#   ifdef DUNE_PYMOR_FUNCTIONS_DEFAULT_ALUGRID_CONFORM_WAS_DEFINED_BEFORE
#     undef DUNE_PYMOR_FUNCTIONS_DEFAULT_ALUGRID_CONFORM_WAS_DEFINED_BEFORE
#   else
#     undef ALUGRID_CONFORM
#   endif
#   ifdef DUNE_PYMOR_FUNCTIONS_DEFAULT_ENABLE_ALUGRID_WAS_DEFINED_BEFORE
#     undef DUNE_PYMOR_FUNCTIONS_DEFAULT_ENABLE_ALUGRID_WAS_DEFINED_BEFORE
#   else
