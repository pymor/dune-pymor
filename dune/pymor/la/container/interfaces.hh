...
public:
   ...
   */
  virtual void scal(const double alpha) = delete;
   ...
   */
  virtual std::vector< double >* components(const std::vector< size_t >* component_indices) const = 0;
   ...
   *          absolute value.
   */
  virtual std::pair< size_t, double > amax() const = 0;
